...
@Component({
	...
	template: `
		...
		<footer class="wrap l-containerhorizontal" *ngIf="showAppChrome">
			<div class="footer">
				<ul>
					<li *ngIf="currentTheme.showPoweredByBadgr">Powered by <a href="https://info.badgr.io">Badgr</a></li>
					<li>Copyright &copy; 2015 - {{ copyrightYear }} <a href="https://concentricsky.com" target="_blank">Concentric Sky</a> and contributors.</li>
